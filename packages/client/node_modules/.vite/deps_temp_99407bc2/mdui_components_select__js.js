...
} from "./chunk-5NXSG5ZY.js";
import {
  map
} from "./chunk-VNRSD7ZB.js";
import "./chunk-BFCPFKGO.js";
import {
  ButtonBase
} from "./chunk-KRPTNDAY.js";
import "./chunk-VASSBTSE.js";
import {
  animateTo,
  getDuration,
  getEasing,
  stopAnimations
} from "./chunk-QWSOUNCD.js";
import "./chunk-QUPE6AYD.js";
import {
  observeResize
} from "./chunk-6TBES2UT.js";
import {
  when
} from "./chunk-3VYRW7LT.js";
import "./chunk-2U334T7M.js";
import "./chunk-EGRHWZRV.js";
import "./chunk-PBAFMQN6.js";
import {
  defaultValue
} from "./chunk-PWS7FW7P.js";
import {
  FormController,
  formResets
...
import {
  style,
  svgTag
} from "./chunk-JH2R4MOG.js";
import {
  watch
} from "./chunk-MANR2RU6.js";
import {
  cc
...
import "./chunk-KU7UHSRA.js";
import "./chunk-5IG7YWYZ.js";
import {
  createRef,
  merge,
  ref
} from "./chunk-GS2DJK7P.js";
import "./chunk-ECER6HRX.js";
import {
  $,
  DefinedController,
  JQ,
...
import "./chunk-VQKN5QAP.js";
import "./chunk-FXB45JPN.js";
import {
  LitElement,
  css,
  customElement,
...
} from "./chunk-NPBQ4XSB.js";
import "./chunk-SNAQBZPT.js";

// ../../node_modules/.pnpm/@mdui+shared@1.0.7/node_modules/@mdui/shared/icons/clear.js
...
// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/chip/style.js
...
// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/chip/index.js
var Chip = class Chip2 extends ButtonBase {
  ...
  render() {
    ...
    }) : this.disabled || this.loading ? html`<span part="button" class="${className} _a">${this.renderInner()}</span>` : this.renderAnchor({
      className,
      part: "button",
      content: this.renderInner()
    })}`;
...
Chip.styles = [ButtonBase.styles, style2];
__decorate([
...
// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/dropdown/style.js
var style3 = css`:host{--z-index:2100;display:contents}.panel{display:block;position:fixed;z-index:var(--z-index)}`;

// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/dropdown/index.js
var Dropdown = class Dropdown2 extends MduiElement {
  ...
  async onOpenChange() {
    ...
    if (this.open) {
      ...
      if (!this.hasTrigger("focus") && isFunction((_a = this.triggerElement) == null ? void 0 : _a.focus) && (this.contains(document.activeElement) || this.contains(((_b = document.activeElement) == null ? void 0 : _b.assignedSlot) ?? null))) {
  ...
  disconnectedCallback() {
    ...
    (_a = this.overflowAncestors) == null ? void 0 : _a.forEach((ancestor) => {
  ...
  onDocumentKeydown(event) {
    ...
    if (event.key === "Tab") {
      if (!this.hasTrigger("focus") && isFunction((_a = this.triggerElement) == null ? void 0 : _a.focus)) {
        event.preventDefault();
      }
      this.open = false;
    }
...
Dropdown.styles = [componentStyle, style3];
__decorate([
  property({
    type: Boolean,
    reflect: true,
...
// ../../node_modules/.pnpm/@mdui+jq@3.0.2/node_modules/@mdui/jq/methods/add.js
$.fn.add = function(selector) {
  return new JQ(unique(merge(this.get(), $(selector).get())));
};

// ../../node_modules/.pnpm/@mdui+shared@1.0.7/node_modules/@mdui/shared/helpers/delay.js
var delay = (duration = 0) => {
  return new Promise((resolve) => setTimeout(resolve, duration));
};

// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/menu/menu-style.js
...
// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/menu/menu.js
...
// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/select/style.js
var style4 = css`:host{display:inline-block;width:100%}.hidden-input{display:none}.text-field{cursor:pointer}.chips{display:flex;flex-wrap:wrap;margin:-.5rem -.25rem;min-height:2.5rem}:host([variant=filled][label]) .chips{margin:0 -.25rem -1rem -.25rem}.chip{margin:.25rem}mdui-menu{max-width:none}`;

// ../../node_modules/.pnpm/mdui@2.1.3/node_modules/mdui/components/select/index.js
var Select = class Select2 extends FocusableMixin(MduiElement) {
  ...
  disconnectedCallback() {
    var _a;
    super.disconnectedCallback();
    (_a = this.observeResize) == null ? void 0 : _a.unobserve();
  }
  /**
  ...
  getMenuItemLabelByValue(valueItem) {
    ...
    return ((_b = (_a = this.menuItems.find((item) => item.value === valueItem)) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim()) || valueItem;
  }
  resizeMenu() {
  ...
  onDropdownClose() {
    ...
    if (this.contains(document.activeElement) || this.contains(((_a = document.activeElement) == null ? void 0 : _a.assignedSlot) ?? null)) {
      setTimeout(() => {
        this.focus();
      });
    }
  ...
  async onValueChange(e) {
    ...
    if (form && ((_a = formResets.get(form)) == null ? void 0 : _a.has(this))) {
      this.invalid = false;
...
Select.styles = [componentStyle, style4];
__decorate([
  property({ reflect: true })
...
//# sourceMappingURL=mdui_components_select__js.js.map
