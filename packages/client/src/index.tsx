...
if (import.meta.env.DEV) {
  // Only attach the devtools overlay in development builds
  try {
    attachDevtoolsOverlay();
  } catch (e) {
    // ignore failures attaching devtools in odd environments
    console.warn("Failed to attach devtools overlay:", e);
  }
}
