...
export const ServerList = (props: Props) => {
  ...
  // Feature flag to show the 'Switch back to legacy app' control.
  // Default is false so the control remains hidden. Set to true to display it.
  const SHOW_LEGACY_SWITCH = false;
