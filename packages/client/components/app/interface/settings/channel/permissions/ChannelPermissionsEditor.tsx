...
export function ChannelPermissionsEditor(props: Props) {
  ...
  // transient UI feedback when saving permissions
  const [savedVisible, setSavedVisible] = createSignal(false);
  ...
  function save() {
    ...
    // show a small confirmation bubble for a short duration
    setSavedVisible(true);
    setTimeout(() => setSavedVisible(false), 800);
  }
  ...
  return (
    <div class={css({ display: "flex", flexDirection: "column" })}>
      ...
      <StickyPanel>
        ...
        <Show when={savedVisible()}>
          <div style={{ "margin-top": "8px", "font-size": "0.85em" }}>
            <Text>Permissions saved</Text>
          </div>
        </Show>
      </StickyPanel>
    </div>
